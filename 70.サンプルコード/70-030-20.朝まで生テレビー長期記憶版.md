...
- 長期記憶は、[70-30-010-30.朝まで生テレビー短期記憶版](70.サンプルコード/70-30-010-30.朝まで生テレビー短期記憶版.md)で作成した短期記憶に対して、長期記憶の設定を追加するだけで対応できます。
# ネームスペースの設計
...
期記憶の方式と戦略を作成したら、`Strategy ID` を控えておきまし

- **Strategy ID: summary_builtin_lodbf-2whoD9DEDz**

この設定によって、短期記憶に対する**長期記憶の自動抽出**が開始されます。

# サンプルコード

短期記憶からの長期記憶の抽出は、**追加のコーディングなしで自動的に行われます**。
