...
```
../files/korehananigomi2024.xlsx
↓
s3://knowledge-base-test-12345/source/korehananigomi2024.xlsx
```

# Bedrock Knowledge Base作成

Amazon Bedrock Knowledge Baseについては、『[81-00.BedrockKnowldegeBaseとは](../81.BedrockKnowledgeBase/81-00.BedrockKnowldegeBaseとは.md)』を参照要。
...
- **Add To Amazon Cloud** : Watch Logs
- **Destination log group**: /aws/vendedlogs/bedrock/knowledge-base/APPLICATION_LOGS/${resourceId}
...
- **Chunking strategy**: Hierarchical chunking
    ...
    - Overlap tokens between chunks: `30`※子チャンクの10%~20%
...
<img src="../images/opensearch_service.png" width="800" alt="ベクトルストア">
...
これにより、**S3に保存されたExcelファイルが読み込まれ、ベクトル化されてベクトルストアに格納**されます。

<img src="../images/data_source.png" width="800" alt="データソース">


### ナレッジベースをテスト

ベクトルストアへのデータ取り込み後、このテスト機能を利用することで、  クエリに対して適切なナレッジが検索・取得できているかを即座に検証できま

<img src="../images/knowledge_base.png" width="800" alt="データソース">


<img src="../images/knowledge_base_test.png" width="800" alt="ナレッジベーステスト">
