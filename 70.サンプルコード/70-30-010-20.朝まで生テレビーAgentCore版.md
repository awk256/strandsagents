...
```
[search_taiwan_news.json]の内容をコピーペ。
```
---
...
- **In-line scehma editor:**
```
[search_tahara_personality.json]の内容をコピーペ
```
---
- **Create gateway: Click**

ゲートウェイの作成が完了したら、**Gateways** の一覧から `My Gateway Name` をクリックし、**以下の情報を控えておきましょう**。
...
-  **AgentCore.Discovery URL: `https://cognito-idp.us-east-1.amazonaws.com/us-east-1_6EiNfrH8r`の「us-east_6EiNfrH8r(User poo ID)」で User Pool Name を特定する**
