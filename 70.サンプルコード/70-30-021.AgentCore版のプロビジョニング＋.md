...
```
- Function ARN: arn:aws:lambda:us-east-1:123412341234:function:search_taiwan_news
...
```
- Function ARN: arn:aws:lambda:us-east-1:123412341234:function:search_tahara_personality

## 🚪 AgentCore Gateway 作成
